...
import TimerComponent from "@/components/AkarkardComponents/Timer";
...
const EditUser: React.FC = () => {
    ...
    const handleSave = async () => {
        try {
            await axios.post("/api/users/edit", formData, {
    ...
    return (
        <div className="w-full flex justify-center mt-10 mb-10">
            <div className="w-11/12 max-w-5xl bg-gray-100 rounded-xl p-6" dir="rtl">
                ...
                <h2 className="text-xl font-bold mb-6 text-right">ویرایش کاربر</h2>
